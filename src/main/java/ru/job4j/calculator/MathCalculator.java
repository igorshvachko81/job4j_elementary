...
public class MathCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчёта sumDiffDiv равен: " + sumDiffAndDiv(10, 20));
        System.out.println("Результат расчёта sumSumMultiplyDiffDiv равен: " + sumSumMultiplyDiffDiv(10, 20));
    }
    ...
    public static double sumSumMultiplyDiffDiv(double first, double second) {
